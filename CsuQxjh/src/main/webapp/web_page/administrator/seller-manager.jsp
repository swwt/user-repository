...
<body>
					...
					<div class="table-wrapper orders-table section">
						...
						<div class="row-fluid">
							<table class="table table-hover">
								<thead>
									<tr>
										<th class="span2">店铺名称</th>
										<th class="span2"><span class="line"></span> 负责人</th>
										<th class="span3"><span class="line"></span> 联系电话</th>
										<th class="span3"><span class="line"></span> 所在地区</th>
										<th><span class="line"></span> 操作</th>
									</tr>
								</thead>
								<tbody>
									<!-- row -->
									<c:if test="${requestScope.data != null}">
										<c:forEach var="sellor" items="${requestScope.data.sellors}"
											varStatus="status">
											<tr>
												<td>${sellor.sellor_company }</td>
												<td>${sellor.sellor_real_name }</td>
												<td>${sellor.sellor_phone }</td>
												<td>${sellor.sellor_company_address }</td>
												<td>
	...
	<script
		src="${pageContext.request.contextPath}/web_page/administrator/js/bootstrap.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/web_page/administrator/js/theme.js"></script>
